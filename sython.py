...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Source_elesyed"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Fk_YT"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@sorce_elesyeed"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس الاسياد يعمل بنجاح ⚡️⚡️**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس العراق⛤ يعمل بنجاح ⚡️**')
...
💞 مرحبا بك في اوامر سورس العراق⛤ [@OM0OM ]
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس العراق⛤ 
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('Source_elesyed'))
        ...
        await sython1.send_message(event.chat_id, "𖣘𝐈𝐑𝐀𝐐𖣘|نتهاء من التجميع | 𖣘𝐈𝐑𝐀𝐐𖣘")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع |𖣘𝐈𝐑𝐀𝐐𖣘")
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس الاسياد سنترال**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('Source_elesyed'))
